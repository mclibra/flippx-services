				...
				if (apiDrawDate !== lotteryDate) {
					...
					try {
						...
						if (
							...
							// Get API's timezone from gameDetails
							const apiDrawTimezone =
						...
						try {
							...
							if (pick3ApiDrawDate !== lotteryDate) {
								...
								if (
									...
									// Get API's timezone from gameDetails for pick3
									const pick3ApiDrawTimezone =
